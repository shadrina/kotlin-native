...
internal val serializerPhase = konanUnitPhase(
        op = {
            ...
            val serializer = KlibMetadataSerializationUtil(this.config.configuration.languageVersionSettings, config.configuration.get(CommonConfigurationKeys.METADATA_VERSION)!!, declarationTable)
